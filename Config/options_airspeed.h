...
#define MINIMUM_GROUNDSPEED          1.0
//will be redefined?
#define MINIMUM_AIRSPEED             4.7   // 2? km/h
#define CRUISE_AIRSPEED             10.0   // 2? km/h, Gliding airspeed when aircraft is level
#define MAXIMUM_AIRSPEED            16.1   // 4? km/h
...
#define MINIMUM_GROUNDSPEED          1.0
//will be redefined?
#define MINIMUM_AIRSPEED             8.0    //  km/h
