...
#define AIRSPEED_PITCH_KI            0.009    // Integration rate.  low = unstable, high = slow response.
...
// Airspeed error integrator
#define AIRSPEED_PITCH_KI            0.009   // Integration rate.  High? = unstable, low? = slow response.
